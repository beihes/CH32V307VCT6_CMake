...
void UDISK_SCSI_CMD_Deal(void)
{
    ...
    if ((mBOC.mCBW.mCBW_Sig[0] == 'U') && (mBOC.mCBW.mCBW_Sig[1] == 'S') && (mBOC.mCBW.mCBW_Sig[2] == 'B') && (mBOC.mCBW.mCBW_Sig[3] == 'C'))
    {
        ...
        case CMD_U_INQUIRY:
            ...
            UDISK_Inquity_Tab[32] = (uint8_t)(w25xxxID >> 24);
            UDISK_Inquity_Tab[33] = (uint8_t)(w25xxxID >> 16);
            UDISK_Inquity_Tab[34] = (uint8_t)(w25xxxID >> 8);
            UDISK_Inquity_Tab[35] = (uint8_t)(w25xxxID);
#endif
            /* UDISK模式 */
...
void UDISK_Up_OnePack(void)
{
    ...
    {
        W25XXX_RD_Block_Start(UDISK_Cur_Sec_Lba * DEF_UDISK_SECTOR_SIZE);
    }
    W25XXX_RD_Buffer(UDisk_Pack_Buffer, UDISK_Pack_Size);
...
#if (STORAGE_MEDIUM == MEDIUM_SPI_W25XXX)
        W25XXX_Erase_Sector(sec_start_addr);
#endif
    }
